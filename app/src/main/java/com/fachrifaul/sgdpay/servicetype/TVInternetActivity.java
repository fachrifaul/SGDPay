...
public class TVInternetActivity extends AppCompatActivity {
    ...
    public static Intent getStartIntent(Context context, String titleScreen) {
        Intent intent = new Intent(context, TVInternetActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tvinternet);
    ...
    private void productChoice() {
        new MaterialDialog.Builder(this)
                .title("Pilih Produk")
                .items(R.array.tv_internet_values)
                .itemsCallbackSingleChoice(0, new MaterialDialog.ListCallbackSingleChoice() {
                    @Override
                    public boolean onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                        String message = "Anda akan membayar "+text+" no " +  customerNumberEditText.getText().toString() +
